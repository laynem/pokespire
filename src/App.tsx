...
function AnimatedRoutes() {
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div key={location.pathname} className={`animate-fade-in flex-1 relative ${['/pokedex', '/collection', '/achievements'].includes(location.pathname) ? 'overflow-y-auto' : 'overflow-hidden'}`}>
        <Routes>
