...
export const NODE_META: Record<NodeType, { icon: string; label: string; color: string; glow: string }> = {
  ...
  normal_battle: { icon: '⚔️',  label: 'Wild Battle',    color: 'border-red-500 bg-red-950',       glow: 'shadow-[0_0_16px_rgba(239,68,68,0.6)]' },
  elite_battle:  { icon: '🧑‍🏫', label: 'Trainer',        color: 'border-orange-400 bg-orange-950', glow: 'shadow-[0_0_16px_rgba(251,146,60,0.6)]' },
  boss:          { icon: '🏆',  label: 'Gym Leader',     color: 'border-yellow-300 bg-yellow-950', glow: 'shadow-[0_0_20px_rgba(250,204,21,0.8)]' },
  gym:           { icon: '🏆',  label: 'Gym Leader',     color: 'border-yellow-300 bg-yellow-950', glow: 'shadow-[0_0_20px_rgba(250,204,21,0.8)]' },
  catch:         { icon: '🎣',  label: 'Catch',          color: 'border-green-400 bg-green-950',   glow: 'shadow-[0_0_16px_rgba(74,222,128,0.6)]' },
  rest:          { icon: '🏕️',  label: 'Rest Site',      color: 'border-amber-400 bg-amber-950',   glow: 'shadow-[0_0_16px_rgba(251,191,36,0.6)]' },
  pokecenter:    { icon: '🏥',  label: 'Pokémon Center', color: 'border-pink-400 bg-pink-950',     glow: 'shadow-[0_0_16px_rgba(244,114,182,0.6)]' },
