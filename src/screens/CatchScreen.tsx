...
function PokemonSprite({ pokemonId }: { pokemonId: number }) {
  ...
  return <img src={spriteUrl} alt="" className="w-32 h-32 object-contain" style={{ imageRendering: 'pixelated' }} />;
}
...
export default function CatchScreen() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center px-4 py-8 gap-5 max-w-lg mx-auto">
      ...
      {/* Pokemon info card */}
      <div className="bg-gray-800 border border-gray-700 rounded-2xl p-6 w-full flex flex-col items-center gap-3">
      ...
      {/* Move list */}
      <div className="bg-gray-800 border border-gray-700 rounded-xl w-full p-4 flex flex-col gap-2">
